...
int main(int argc, char **argv)
{
    ...
    sim_lib = LoadLibrary(TEXT("isim/_tmp/work/tb_micro_pk_isim_beh.exe_lib.nt.dll"));
    if (!sim_lib)
    {
        fprintf(stderr, "Could not open simulation library isim/_tmp/work/tb_micro_pk_isim_beh.exe_lib.nt.dll\n");
        return 1;
    }
